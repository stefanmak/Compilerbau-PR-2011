...
public class ParseException extends Exception implements CompilerError {
	...
	/**
	 * Declare variables for the Compiler Construction deliver format
	 */
	...
	private static String initialise(Token currentToken,
		...
		ParseException.lineNumber = currentToken.next.beginLine;
		ParseException.columnNumber = currentToken.next.beginColumn;
	 ...
	 */
	public int line() {
		return ParseException.lineNumber;
	}
	 ...
	 */
	public int column() { 
		return ParseException.columnNumber;
	}
